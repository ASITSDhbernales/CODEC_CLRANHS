...
// Define the content for C# lessons
final Lesson c_lesson_1 = Lesson(
  ...
  topics: [
    ...
    Topic(id: 'c_topic_1', title: 'Terminator',
      ...
      imageUrl: 'assets/terminator.png',),
    ...
    Topic(id: 'c_topic_1', title: 'Input/Output',
      ...
      imageUrl: 'assets/inputoutput.png',),
    ...
    Topic(id: 'c_topic_1', title: 'Off-Page Connector',
      ...
      imageUrl: 'assets/offpageconnector.png',),
    Topic(id: 'c_topic_1', title: 'Pre-Defined Process',
      ...
      imageUrl: 'assets/predefinedprocess.png',),
    ...
    Topic(id: 'c_topic_1', title: 'Pseudocode',
      ...
      imageUrl: 'assets/pseudocode.png',),
...
final Lesson c_lesson_2 = Lesson(
  ...
  topics: [
    ...
    Topic(id: 'c_topic_2', title: 'Comparison of Low and High Level Languages',
      content: '',
      imageUrl: 'assets/comparison.png',),
    ...
    Topic(id: 'c_topic_2', title: 'Example of C# Code',
      content: '',
      imageUrl: 'assets/csharpcode.png',),
...
final Lesson c_lesson_5 = Lesson(
  ...
  topics: [
    ...
    Topic(id: 'c_topic_5', title: 'Arithmetic Operators',
        ...
        imageUrl: 'assets/arithmetic.png'),
    Topic(id: 'c_topic_5', title: 'Relational Operators',
        ...
        imageUrl: 'assets/relational.png'),
    ...
    Topic(id: 'c_topic_5', title: 'Compound Assignment Operators',
        ...
        imageUrl: 'assets/compound1.png'),
    Topic(id: 'c_topic_5', title: 'Compound Assignment Operators',
        content: '',
        imageUrl: 'assets/compound2.png'),
    ...
    Topic(id: 'c_topic_5', title: 'Type Conversion',
        ...
        imageUrl: 'assets/conversion.png'),
    ...
    Topic(id: 'c_topic_5', title: 'Type Conversion Methods',
        content: '',
        imageUrl: 'assets/conversionmethods1.png'),
    Topic(id: 'c_topic_5', title: 'Type Conversion Methods',
        content: '',
        imageUrl: 'assets/conversionmethods2.png'),
  ],
  quizzes: [
    Quiz(
      id: 'c_quiz_5',
...
final Lesson c_lesson_6 = Lesson(
  ...
  topics: [
    ...
    Topic(id: 'c_topic_6', title: 'Devices for Console Input',
        ...
        imageUrl: 'assets/inputdevice.png'),
    Topic(id: 'c_topic_6', title: 'Devices for Console Output',
        ...
        imageUrl: 'assets/outputdevice.png'),
...
final Lesson c_lesson_7 = Lesson(
  ...
  topics: [
    Topic(id: 'c_topic_7', title: 'Introduction to Conditional Statements',
        ...
        imageUrl: 'assets/conditional_intro.png'),
    Topic(id: 'c_topic_7', title: 'The if Statement',
        content: 'The if statement executes a block of code if its condition evaluates to true.',
        imageUrl: 'assets/if_statement.png'),
    Topic(id: 'c_topic_7', title: 'The else Statement',
        content: 'The else statement executes a block of code if the condition in the if statement evaluates to false.',
        imageUrl: 'assets/else_statement.png'),
    Topic(id: 'c_topic_7', title: 'The else if Statement',
        content: 'The else if statement is used to test multiple conditions.',
        imageUrl: 'assets/elseif_statement.png'),
    Topic(id: 'c_topic_7', title: 'The switch Statement',
        ...
        imageUrl: 'assets/switch_statement.png'),
  ],
  quizzes: [
    Quiz(
      id: 'c_quiz_7',
      question: 'Which statement is used to test multiple conditions in sequence?',
      options: ['if-else', 'else if', 'switch'],
      correctOptionIndex: 1,
    ),
    Quiz(
      id: 'c_quiz_7',
      question: 'Which statement is ideal for evaluating a single variable against many cases?',
      options: ['if', 'else if', 'switch'],
      correctOptionIndex: 2,
    ),
  ],
  status: LessonStatus.locked,
...
final Lesson c_lesson_8 = Lesson(
  ...
  isOngoing: false,
  topics: [
    Topic(id: 'c_topic_8', title: 'Introduction to Loops',
        content: 'Loops are used to execute a block of code repeatedly as long as a condition is true.',
        imageUrl: 'assets/loops_intro.png'),
    Topic(id: 'c_topic_8', title: 'The for Loop',
        content: 'The for loop is used when the number of iterations is known. It consists of initialization, condition, and increment/decrement.',
        imageUrl: 'assets/for_loop.png'),
    Topic(id: 'c_topic_8', title: 'The while Loop',
        content: 'The while loop executes a block of code as long as its condition evaluates to true.',
        imageUrl: 'assets/while_loop.png'),
    Topic(id: 'c_topic_8', title: 'The do-while Loop',
        content: 'The do-while loop is similar to the while loop but guarantees at least one execution of the code block.',
        imageUrl: 'assets/dowhile_loop.png'),
  ],
  quizzes: [
    Quiz(
      id: 'c_quiz_8',
    ...
    Quiz(
      id: 'c_quiz_8',
      question: 'Which loop is best suited for iterating over a fixed range?',
...
final Lesson c_lesson_9 = Lesson(
  ...
  isOngoing: false,
  topics: [
    Topic(id: 'c_topic_9', title: 'Introduction to Methods',
        content: 'Methods are blocks of code that perform a specific task and can be reused.',
        imageUrl: 'assets/methods_intro.png'),
    Topic(id: 'c_topic_9', title: 'Method Parameters',
        content: 'Parameters allow methods to accept input values and perform operations with them.',
        imageUrl: 'assets/method_parameters.png'),
    Topic(id: 'c_topic_9', title: 'Encapsulation',
        content: 'Encapsulation is a principle of object-oriented programming that bundles data and methods within a class, restricting direct access.',
        imageUrl: 'assets/encapsulation.png'),
  ],
  quizzes: [
    Quiz(
      id: 'c_quiz_9',
...
final Lesson c_lesson_10 = Lesson(
  ...
  isOngoing: false,
  topics: [
    Topic(id: 'c_topic_10', title: 'Introduction to Arrays',
        content: 'Arrays are collections of elements stored in contiguous memory locations, accessible by an index.',
        imageUrl: 'assets/arrays_intro.png'),
    Topic(id: 'c_topic_10', title: 'Declaring and Initializing Arrays',
        content: 'Arrays can be declared by specifying their type and size. They can also be initialized with values at the time of declaration.',
        imageUrl: 'assets/array_declaration.png'),
    Topic(id: 'c_topic_10', title: 'Accessing Array Elements',
        content: 'Array elements can be accessed using their index, starting from zero.',
        imageUrl: 'assets/array_access.png'),
    Topic(id: 'c_topic_10', title: 'Iterating Through Arrays',
        content: 'Loops such as for or foreach are commonly used to iterate through array elements.',
        imageUrl: 'assets/array_iteration.png'),
  ],
  quizzes: [
    Quiz(
      id: 'c_quiz_10_1',
      question: 'What is the starting index of an array in C#?',
      options: ['0', '1', 'Depends on the array'],
      correctOptionIndex: 0,
    ),
    Quiz(
      id: 'c_quiz_10_2',
      question: 'Which loop is best suited for iterating through array elements?',
      options: ['while', 'for', 'do-while'],
      correctOptionIndex: 1,
    ),
  ],
