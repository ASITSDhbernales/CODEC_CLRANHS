...
List<ReviewLevel> generateReviewLevels() {
  return [
    ...
    ReviewLevel(level: 3, items: 5, quizzes: [...allLessons['c_lesson_4']!.quizzes, ...allLessons['c_lesson_5']!.quizzes,].toList()..shuffle()),
    ReviewLevel(level: 4, items: 3, quizzes: [...allLessons['c_lesson_6']!.quizzes, ...allLessons['c_lesson_7']!.quizzes,...allLessons['c_lesson_8']!.quizzes,
    ].toList()..shuffle()),
    ReviewLevel(level: 5, items: 3, quizzes: [...allLessons['c_lesson_9']!.quizzes, ...allLessons['c_lesson_10']!.quizzes,
    ].toList()..shuffle()),
  ];
}
